 ...
 * 
 * @author Rex.Tan
 * @date 2020年8月30日 下午2:45:12
 */
@Data
public class SpVoucherReceive implements Serializable {
	...
	@ApiModelProperty(value = "状态(1:未使用,2:已使用,3:已过期,4:失效 )")
	@IntValue(message = "状态(1:未使用,2:已使用,3:已过期,4:失效 )取值超出范围")
	@NotNull(message = "状态(1:未使用,2:已使用,3:已过期,4:失效 )不能为空")
