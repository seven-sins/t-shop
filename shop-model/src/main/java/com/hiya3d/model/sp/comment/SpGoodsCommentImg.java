 ...
 * 
 * @author Rex.Tan
 * @date 2020年8月30日 下午2:36:45
 */
@Data
public class SpGoodsCommentImg implements Serializable {
	...
	@Length(max = 32, message = "评论ID输入超出最大长度(32)")
	@NotBlank(message = "评论ID不能为空")
	private String commentId;

	@ApiModelProperty(value = "url")
	@Length(max = 500, message = "url输入超出最大长度(500)")
